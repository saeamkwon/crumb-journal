...
const COMMUNITY_POSTS = [
  { id: 1, user: "Sophie M.", location: "Lyon, France", avatar: "🇫🇷", recipe: "Kouign-Amann", image: "🥐", likes: 142, comment: "Third attempt and I finally nailed the caramelization! Don't panic when butter pools at the bottom.", tags: ["advanced", "pastry"], time: "2h ago" },
  { id: 2, user: "Priya K.", location: "Mumbai, India", avatar: "🇮🇳", recipe: "Cardamom Rose Rolls", image: "🌹", likes: 98, comment: "Added saffron to the glaze — absolutely transformed these.", tags: ["intermediate", "fusion"], time: "5h ago" },
  { id: 3, user: "James T.", location: "Portland, OR", avatar: "🌲", recipe: "Brown Butter Choc Chip Cookies", image: "🍪", likes: 203, comment: "Used the resource on browning butter and WOW. Never going back.", tags: ["beginner", "cookies"], time: "1d ago" },
  { id: 4, user: "Yuki N.", location: "Tokyo, Japan", avatar: "🇯🇵", recipe: "Matcha Basque Cheesecake", image: "🍵", likes: 317, comment: "The burnt top is the best part. Trust the process!", tags: ["intermediate", "cheesecake"], time: "1d ago" },
  { id: 5, user: "Elena V.", location: "Barcelona, Spain", avatar: "🇪🇸", recipe: "Pan de Cristal", image: "🍞", likes: 88, comment: "78% hydration dough is a nightmare but the result is pure glass-like crunch.", tags: ["advanced", "bread"], time: "2d ago" },
];
...
const SEED_RECIPE = {
  ...
  description: "Classic chocolate chip cookies elevated with nutty brown butter and a sprinkle of flaky sea salt.",
  servings: "24 cookies",
  ...
  ingredients: [
    { name: "Unsalted butter", amount: "225g (2 sticks)", note: "Will be browned" },
    { name: "Brown sugar", amount: "200g (1 cup packed)", note: null },
    { name: "Granulated sugar", amount: "100g (½ cup)", note: null },
    { name: "Eggs", amount: "2 large", note: "Room temperature" },
    { name: "Vanilla extract", amount: "2 tsp", note: null },
    { name: "All-purpose flour", amount: "280g (2¼ cups)", note: null },
    { name: "Baking soda", amount: "1 tsp", note: null },
    { name: "Salt", amount: "1 tsp", note: null },
    { name: "Chocolate chips", amount: "340g (2 cups)", note: "Semi-sweet or mix" },
    { name: "Flaky sea salt", amount: "for topping", note: "Maldon recommended" },
  ],
  steps: [
    { instruction: "Brown the butter: In a light-colored saucepan over medium heat, melt the butter, stirring constantly. Continue cooking until it turns golden amber and smells nutty — about 6–8 minutes. Pour immediately into a large mixing bowl and let cool for 10 minutes.", skill: "Browning Butter", skillLevel: "intermediate", tip: "Use a light-colored pan so you can see the color change. The butter will foam twice — once when it melts, once just before it's done. Pull it off the heat the moment you see brown specks and smell hazelnuts. Err on the side of pulling early — burnt butter is bitter.", timer: "6–8 minutes" },
    { instruction: "Whisk both sugars into the cooled brown butter until combined. The mixture should look thick and glossy.", skill: null, skillLevel: null, tip: null, timer: null },
    { instruction: "Add eggs one at a time, whisking vigorously for 30 seconds after each addition. Add vanilla. The batter should look smooth and ribbon-like.", skill: null, skillLevel: null, tip: null, timer: "1 minute whisking" },
    { instruction: "Fold in the flour, baking soda, and salt with a spatula until just combined — stop as soon as you no longer see dry streaks. Over-mixing develops gluten and makes cookies tough.", skill: null, skillLevel: null, tip: null, timer: null },
    { instruction: "Fold in the chocolate chips. Cover the bowl with plastic wrap and refrigerate for at least 30 minutes, or up to 72 hours. Chilling deepens flavor and prevents overspreading.", skill: null, skillLevel: null, tip: null, timer: "30 min minimum chill" },
    { instruction: "Preheat oven to 375°F (190°C). Line two baking sheets with parchment paper. Scoop dough into 2-tablespoon balls and place 2 inches apart.", skill: null, skillLevel: null, tip: null, timer: "Preheat 15 min" },
    { instruction: "Bake for 11–13 minutes until edges are set and golden but centers still look slightly underdone. They will continue cooking on the hot pan.", skill: null, skillLevel: null, tip: null, timer: "11–13 minutes" },
    { instruction: "Immediately sprinkle with flaky sea salt. Let cookies cool on the baking sheet for 5 minutes before transferring to a wire rack.", skill: null, skillLevel: null, tip: null, timer: "5 min rest" },
  ],
};
...
const SEED_SESSIONS = [
  {
    id: 1001,
    recipeName: "Brown Butter Chocolate Chip Cookies",
    recipeData: SEED_RECIPE,
    photo: "🍪",
    rating: 3,
    date: "Jan 4, 2025",
    stepNotes: {
      0: "Took about 7 min. Not sure if I got it dark enough — pulled it when it just started smelling nutty.",
      6: "Pulled at exactly 12 min. Edges were golden but middle felt soft — panicked a bit.",
    },
    notes: {
      general: "Cookies spread a lot more than expected and came out quite flat. Taste was good but texture wasn't quite right — too crispy once they cooled. Also felt like they needed more salt.",
      changes: "Chill the dough longer next time — at least an hour, maybe overnight. Also try browning the butter a bit more aggressively. Reduce bake time to 11 min, they got a bit overdone. Add more flaky salt on top.",
      makeAgain: "Definitely!",
    },
    parsedStepNotes: {
      "0": "Brown the butter more aggressively — pull it darker this time for more nuttiness.",
      "4": "Chill overnight (or at least 1 hour) — this will fix the spreading problem.",
      "6": "Reduce bake time to 11 min max — 12 min was slightly overdone.",
      "7": "Be more generous with the flaky sea salt on top.",
    },
  },
  {
    id: 1002,
    ...
    date: "Jan 19, 2025",
    stepNotes: {
      0: "Went much darker this time — almost nervous but it smelled amazing. Deep hazelnut aroma.",
      4: "Chilled overnight in the fridge. Dough was really firm coming out.",
      6: "Pulled at 11 min exactly. Centers looked underdone but trusted the process.",
    },
    notes: {
      general: "So much better! Cookies stayed thick and chewy, didn't spread nearly as much. The deeper brown butter flavor was really noticeable. Centers were perfectly fudgy. Only issue — a tiny bit too sweet for my taste.",
      changes: "Reduce the granulated sugar slightly — maybe 80g instead of 100g. Also try adding a tiny bit of espresso powder to enhance the chocolate flavor. The overnight chill is non-negotiable, keep doing that.",
      makeAgain: "Definitely!",
    },
    parsedStepNotes: {
      "1": "Reduce granulated sugar to 80g (down from 100g) — slightly too sweet.",
      "1b": "Try adding ½ tsp espresso powder with the sugars to deepen chocolate flavor.",
      "4": "Overnight chill is essential — keep doing this every time.",
    },
  },
  {
    id: 1003,
    ...
    date: "Feb 2, 2025",
    stepNotes: {
      0: "Perfect — dark amber, deeply nutty. Nailed it.",
      1: "Used 80g granulated sugar + added ½ tsp espresso powder. Batter smelled incredible.",
      4: "36-hour chill. Best decision ever.",
      6: "11 min at 375°F. Pulled when centers looked glossy and just barely set.",
    },
    notes: {
      general: "These are IT. Perfect thick and chewy centers, slightly crisp edges, deep caramel-chocolate flavor from the espresso powder. Everyone at the dinner party asked for the recipe. The 36-hour chill made a huge difference in flavor complexity.",
      changes: "This is pretty much perfect now. Maybe experiment with a mix of chocolate — 50% chips and 50% chopped dark chocolate bar for better melting pools. Could also try adding toasted walnuts for texture.",
      makeAgain: "Definitely!",
    },
    parsedStepNotes: {
      "3": "Try 50% chocolate chips + 50% chopped dark chocolate bar for better melty pools.",
      "3b": "Consider folding in ½ cup toasted walnuts for added crunch and depth.",
    },
  },
];
...
function useAppState() {
  ...
  const set = useCallback((u) => setState(p => ({ ...p, ...(typeof u === "function" ? u(p) : u) })), []);
  const notify = useCallback((msg, type = "success") => {
    setState(p => ({ ...p, notification: { msg, type } }));
    setTimeout(() => setState(p => ({ ...p, notification: null })), 3200);
  }, []);
...
// ─── SIDEBAR ───────────────────────────────────────────────────────────────────
const BAKING_SESSION_SCREENS = ["new-session"];

function Sidebar({ screen, set, user, collapsed, onToggle }) {
  const nav = [
    ...
    <div style={{ width: w, minHeight: "100vh", background: THEME.darkBrown, display: "flex", flexDirection: "column", padding: collapsed ? "24px 10px" : "24px 14px", position: "fixed", left: 0, top: 0, zIndex: 100, transition: "width 0.25s ease, padding 0.25s ease", overflow: "hidden" }}>
      ...
      {!collapsed && (
        <div style={{ padding: "14px 10px", borderTop: "1px solid rgba(255,255,255,0.1)" }}>
          <div style={{ fontFamily: "'DM Sans',sans-serif", color: "rgba(255,255,255,0.75)", fontSize: 13, fontWeight: 600, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{user?.name}</div>
          <div style={{ fontFamily: "'DM Sans',sans-serif", color: "rgba(255,255,255,0.4)", fontSize: 11, marginTop: 2 }}>
            {SKILL_LEVELS.find(s => s.id === user?.skill)?.icon} {SKILL_LEVELS.find(s => s.id === user?.skill)?.label}
          </div>
        </div>
      )}
      {collapsed && (
        <div style={{ display: "flex", justifyContent: "center", paddingBottom: 8 }}>
          <span style={{ fontSize: 20 }}>{SKILL_LEVELS.find(s => s.id === user?.skill)?.icon || "👤"}</span>
        </div>
      )}
    </div>
  );
...
function PageWrapper({ children, sidebarWidth }) {
  return (
    <div style={{ marginLeft: sidebarWidth, minHeight: "100vh", background: THEME.cream, padding: "38px 40px", transition: "margin-left 0.25s ease" }}>
      {children}
    </div>
  );
}
...
// ─── LOGIN ─────────────────────────────────────────────────────────────────────
function LoginScreen({ set, notify }) {
  ...
  const handle = async () => {
    ...
    set({ user: { name: name || email.split("@")[0], email, skill: "intermediate", joinDate: "January 2025" }, sessions: SEED_SESSIONS, screen: "my-recipes" }); notify("Welcome back! Your cookie journey awaits 🍪");
    setLoading(false);
  };
  return (
    <div style={{ minHeight: "100vh", background: `linear-gradient(160deg,${THEME.cream},${THEME.parchment})`, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ width: "100%", maxWidth: 420 }}>
        ...
        <Card>
          ...
          {mode === "signup" && <Input label="Your Name" value={name} onChange={setName} placeholder="e.g. Julia" />}
          ...
          <p style={{ textAlign: "center", marginTop: 14, fontSize: 12, color: THEME.textLight, fontFamily: "'DM Sans',sans-serif" }}>Demo: any email + password works</p>
        </Card>
...
// ─── ONBOARDING ────────────────────────────────────────────────────────────────
function OnboardingScreen({ set, state, notify }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: THEME.cream, padding: 40, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ maxWidth: 620, width: "100%" }}>
        ...
        <Btn full size="lg" onClick={() => { if (!selected) return notify("Please select your skill level", "error"); set({ user: { ...state.user, skill: selected }, screen: "dashboard" }); notify("Welcome to Crumb Journal! 🎉"); }}>Start Baking →</Btn>
      </div>
    </div>
  );
}
...
// ─── DASHBOARD ─────────────────────────────────────────────────────────────────
function DashboardScreen({ state, set, sw }) {
  const { sessions, user } = state;
  return (
    <PageWrapper sidebarWidth={sw}>
      <PageHeader title={`Good morning, ${user?.name?.split(" ")[0]} 👋`} subtitle={`Member since ${user?.joinDate}`} action={<Btn onClick={() => set({ screen: "new-session" })}>＋ New Session</Btn>} />
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: 18, marginBottom: 32 }}>
        {[{ label: "Bakes Logged", value: sessions.length, icon: "🍰", color: THEME.accentLight }, { label: "Recipes Tried", value: new Set(sessions.map(s => s.recipeName)).size, icon: "📖", color: THEME.greenLight }, { label: "Skill Level", value: SKILL_LEVELS.find(s => s.id === user?.skill)?.label || "Not Set", icon: "⭐", color: THEME.tan }].map(stat => (
                ...
                <Card key={s.id} style={{ padding: 14 }} onClick={() => set({ screen: "my-recipes" })}>
                  <div style={{ display: "flex", gap: 12, alignItems: "center" }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontFamily: "'DM Sans',sans-serif", fontWeight: 700, fontSize: 14, color: THEME.darkBrown, whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{s.recipeName}</div>
                      <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: THEME.textLight, marginTop: 2 }}>{s.date}{s.rating ? ` · ${s.rating}/5 ⭐` : ""}</div>
                    </div>
...
// ─── BAKING SESSION (NEW + BAKE AGAIN) ────────────────────────────────────────
function BakingSessionScreen({ state, set, notify, sw, prefillSession = null }) {
  const [phase, setPhase] = useState(prefillSession ? "walking" : "input");
  const [recipeInput, setRecipeInput] = useState("");
  const [recipe, setRecipe] = useState(prefillSession?.recipeData || null);
  const [parsedStepNotes, setParsedStepNotes] = useState(prefillSession?.parsedStepNotes || {});
  ...
  const photoEmojis = ["🍰", "🎂", "🍪", "🥐", "🍞", "🥧", "🧁", "🥮", "🍩", "🥖"];
  const userSkillIdx = SKILL_LEVELS.findIndex(s => s.id === state.user?.skill);
...
{"name":"string","description":"string","servings":"string","prepTime":"string","cookTime":"string","skillLevel":"beginner|intermediate|advanced|expert","ingredients":[{"name":"string","amount":"string","note":"string or null"}],"steps":[{"instruction":"string","skill":"technique name or null","skillLevel":"beginner|intermediate|advanced|expert|null","tip":"helpful tip or null","timer":"string or null"}],"tags":["string"]}`);
  ...
  const shouldShowTip = (step) => {
    ...
    const idx = SKILL_LEVELS.findIndex(s => s.id === step.skillLevel);
    return idx > userSkillIdx;
  };

  const completeSession = async () => {
    // Parse the "changes" note with AI to attach to specific steps
    ...
    if (reviewNotes.changes.trim() && recipe?.steps) {
      try {
        ...
        const raw = await callClaude(`The user left this note about changes for next time: "${reviewNotes.changes}"
Here are the recipe steps: ${stepsJson}
Map each piece of the user's note to the most relevant step index. Return JSON like: {"stepNotes": {"0": "note for step 0", "3": "note for step 3"}}
Only include steps that have a directly relevant note. Be specific and helpful.`);
        const parsed = JSON.parse(raw.replace(/```json|```/g, "").trim());
        if (parsed.stepNotes) newParsedStepNotes = { ...newParsedStepNotes, ...Object.fromEntries(Object.entries(parsed.stepNotes).map(([k, v]) => [k, v])) };
      } catch { /* fall through silently */ }
    }
    const session = {
      id: Date.now(), recipeName: recipe?.name, recipeData: recipe,
      parsedStepNotes: newParsedStepNotes, photo, rating, notes: reviewNotes,
      date: new Date().toLocaleDateString("en-US", { month: "short", day: "numeric", year: "numeric" }), stepNotes,
      isBakeAgain: !!prefillSession, previousSessionId: prefillSession?.id,
    };
    set(p => ({ ...p, sessions: [...p.sessions, session], screen: "my-recipes" }));
    notify(`"${recipe?.name}" logged to your journal! 🎉`);
  };

  // Full-width layout (no sidebar space waste) when in walking phase
  const inSession = phase === "walking" || phase === "complete" || phase === "review";
      ...
      <div style={{ maxWidth: 640 }}>
        <Card>
          <div style={{ marginBottom: 18 }}>
            ...
            <textarea value={recipeInput} onChange={e => setRecipeInput(e.target.value)} placeholder={"Paste a URL like https://seriouseats.com/chocolate-chip-cookies...\nOr describe: 'classic banana bread'\nOr paste an entire recipe with ingredients and steps"} rows={6} style={{ width: "100%", padding: "13px 14px", borderRadius: 10, border: `1px solid ${THEME.border}`, background: THEME.warmWhite, fontFamily: "'DM Sans',sans-serif", fontSize: 14, color: THEME.text, outline: "none", resize: "vertical", boxSizing: "border-box" }} />
          </div>
      ...
      <PageWrapper sidebarWidth={sw}>
        <div style={{ maxWidth: 760 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 260px", gap: 22 }}>
            <div>
              {/* Previous bake note for this step */}
              {prevNote && (
              ...
              <Input label="Notes for this step (optional)" value={stepNotes[currentStep] || ""} onChange={v => setStepNotes(p => ({ ...p, [currentStep]: v }))} placeholder="e.g. butter browned in 6 min, used salted butter..." multiline rows={3} />
    ...
    <PageWrapper sidebarWidth={sw}>
      <div style={{ maxWidth: 520, margin: "0 auto", textAlign: "center" }}>
        ...
        <Card style={{ marginBottom: 22 }} hover={false}>
          ...
          <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: THEME.textLight }}>Select an emoji to represent your creation</p>
        </Card>
    ...
    <PageWrapper sidebarWidth={sw}>
      <div style={{ maxWidth: 580 }}>
        ...
        <Card style={{ marginBottom: 18 }} hover={false}>
          ...
          <Input label="What would you change next time?" value={reviewNotes.changes} onChange={v => setReviewNotes(p => ({ ...p, changes: v }))} placeholder="e.g. less sugar next time, toast the nuts first, reduce bake time by 3 min..." multiline />
...
// ─── MY RECIPES ────────────────────────────────────────────────────────────────
function MyRecipesScreen({ state, set, notify, sw }) {
  const { sessions } = state;
  const [viewingSession, setViewingSession] = useState(null);

  // Group sessions by recipe name to show history
  const recipeGroups = {};
  sessions.forEach(s => {
    if (!recipeGroups[s.recipeName]) recipeGroups[s.recipeName] = [];
    recipeGroups[s.recipeName].push(s);
  });
  const uniqueRecipes = Object.values(recipeGroups).map(g => ({ latest: g[g.length - 1], history: g }));

  if (viewingSession) {
    const history = recipeGroups[viewingSession.recipeName] || [];
    return (
      <PageWrapper sidebarWidth={sw}>
        <div style={{ maxWidth: 680 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginBottom: 28 }}>
            <Btn variant="ghost" size="sm" onClick={() => setViewingSession(null)}>← Back to Recipes</Btn>
            <h1 style={{ fontFamily: "'Playfair Display',serif", fontSize: 26, color: THEME.darkBrown, margin: 0, flex: 1 }}>{viewingSession.recipeName}</h1>
            <Btn size="sm" onClick={() => set({ screen: "bake-again", bakeAgainSession: viewingSession })}>🔄 Bake Again</Btn>
          </div>

          {/* Bake History Timeline */}
          {history.length > 1 && (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 24 }}>
            ...
            {viewingSession.notes?.makeAgain && <Card style={{ padding: 16 }} hover={false}><div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, color: THEME.textLight, fontWeight: 600, marginBottom: 6 }}>MAKE AGAIN?</div><div style={{ fontFamily: "'DM Sans',sans-serif", fontWeight: 700, color: THEME.green }}>{viewingSession.notes.makeAgain}</div></Card>}
          </div>
          {viewingSession.notes?.general && <Card style={{ marginBottom: 14 }} hover={false}><div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, fontWeight: 700, color: THEME.textLight, marginBottom: 6 }}>GENERAL NOTES</div><p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 14, color: THEME.text, margin: 0, lineHeight: 1.65 }}>{viewingSession.notes.general}</p></Card>}
          {viewingSession.notes?.changes && <Card style={{ background: "#FFF8F0", border: `1px solid ${THEME.accentLight}`, marginBottom: 20 }} hover={false}><div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 12, fontWeight: 700, color: THEME.accent, marginBottom: 6 }}>CHANGES FOR NEXT TIME</div><p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 14, color: THEME.textMid, margin: 0, lineHeight: 1.65 }}>{viewingSession.notes.changes}</p></Card>}
          ...
          <Card style={{ marginBottom: 20 }} hover={false}>
            ...
            {viewingSession.recipeData?.ingredients?.map((ing, i) => (
          ...
          <div style={{ display: "grid", gap: 10 }}>
            {viewingSession.recipeData?.steps?.map((step, i) => {
              const note = viewingSession.parsedStepNotes?.[String(i)];
              const stepNote = viewingSession.stepNotes?.[i];
              return (
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill,minmax(280px,1fr))", gap: 18 }}>
          {uniqueRecipes.reverse().map(({ latest: s, history }) => (
            <Card key={s.id} style={{ display: "flex", flexDirection: "column" }} hover>
              ...
              <h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: 17, color: THEME.darkBrown, margin: "0 0 4px" }}>{s.recipeName}</h3>
              <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: THEME.textLight, marginBottom: 6 }}>Last baked {s.date}{s.rating ? ` · ${"⭐".repeat(s.rating)}` : ""}</div>
              {s.notes?.makeAgain && <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: s.notes.makeAgain === "Definitely!" ? THEME.green : THEME.textLight, marginBottom: 10, fontWeight: 600 }}>{s.notes.makeAgain === "Definitely!" ? "✓ Would make again" : s.notes.makeAgain === "Maybe" ? "~ Maybe again" : "✗ Probably not"}</div>}
              {s.notes?.changes && <div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: THEME.textLight, marginBottom: 12, lineHeight: 1.5, flex: 1 }}>Notes: {s.notes.changes.substring(0, 70)}{s.notes.changes.length > 70 ? "..." : ""}</div>}
              {/* Dual CTAs */}
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 8, marginTop: "auto" }}>
                <Btn variant="ghost" size="sm" full onClick={() => setViewingSession(s)} style={{ justifyContent: "center" }}>📋 View History</Btn>
                <Btn variant="primary" size="sm" full onClick={() => set({ screen: "bake-again", bakeAgainSession: s })} style={{ justifyContent: "center" }}>🔄 Bake Again</Btn>
              </div>
            </Card>
          ))}
        </div>
...
// ─── COMMUNITY ─────────────────────────────────────────────────────────────────
function CommunityScreen({ notify, sw }) {
  const [liked, setLiked] = useState(new Set());
  const toggle = (id) => setLiked(p => { const n = new Set(p); n.has(id) ? n.delete(id) : (n.add(id), notify("Post liked! ❤️")); return n; });
  return (
    <PageWrapper sidebarWidth={sw}>
      <PageHeader title="Community" subtitle="Bakers from around the world sharing their creations" />
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 18 }}>
        {COMMUNITY_POSTS.map(post => (
          <Card key={post.id}>
            <div style={{ width: "100%", height: 130, borderRadius: 10, background: `linear-gradient(135deg,${THEME.parchment},${THEME.accentLight})`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 66, marginBottom: 14 }}>{post.image}</div>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 7 }}>
              <div><div style={{ fontFamily: "'Playfair Display',serif", fontSize: 17, color: THEME.darkBrown, fontWeight: 700 }}>{post.recipe}</div><div style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: THEME.textLight, marginTop: 2 }}>{post.avatar} {post.user} · {post.location}</div></div>
              <span style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 11, color: THEME.textLight }}>{post.time}</span>
            </div>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <button onClick={() => toggle(post.id)} style={{ display: "flex", alignItems: "center", gap: 5, background: "none", border: "none", cursor: "pointer", fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: liked.has(post.id) ? "#E53E3E" : THEME.textLight, fontWeight: liked.has(post.id) ? 700 : 400 }}>{liked.has(post.id) ? "❤️" : "🤍"} {post.likes + (liked.has(post.id) ? 1 : 0)}</button>
            </div>
          </Card>
        ))}
      </div>
...
// ─── SETTINGS ──────────────────────────────────────────────────────────────────
function SettingsScreen({ state, set, notify, sw }) {
  const { user } = state;
  const [sel, setSel] = useState(user?.skill);
  return (
    <PageWrapper sidebarWidth={sw}>
      <PageHeader title="Settings" subtitle="Manage your profile and preferences" />
      <div style={{ maxWidth: 540 }}>
        <Card style={{ marginBottom: 22 }} hover={false}><h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: 19, color: THEME.darkBrown, marginTop: 0 }}>Profile</h3><div style={{ fontFamily: "'DM Sans',sans-serif", marginBottom: 10 }}><span style={{ fontSize: 13, color: THEME.textLight }}>Name: </span><span style={{ fontWeight: 600, color: THEME.text }}>{user?.name}</span></div><div style={{ fontFamily: "'DM Sans',sans-serif" }}><span style={{ fontSize: 13, color: THEME.textLight }}>Email: </span><span style={{ fontWeight: 600, color: THEME.text }}>{user?.email}</span></div></Card>
        <Card style={{ marginBottom: 22 }} hover={false}>
          <h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: 19, color: THEME.darkBrown, marginTop: 0 }}>Baking Skill Level</h3>
          <p style={{ fontFamily: "'DM Sans',sans-serif", fontSize: 13, color: THEME.textLight, marginBottom: 14 }}>Determines when we show technique tips during your baking sessions.</p>
          ...
          <Btn onClick={() => { set({ user: { ...user, skill: sel } }); notify("Skill level updated!"); }}>Save Changes</Btn>
        </Card>
        <Card hover={false}><h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: 19, color: THEME.darkBrown, marginTop: 0 }}>Account</h3><Btn variant="danger" onClick={() => set({ screen: "login", user: null, sessions: [] })}>Sign Out</Btn></Card>
      </div>
    </PageWrapper>
  );
}
...
export default function App() {
  const { state, set, notify } = useAppState();
  const { screen, user, sidebarCollapsed } = state;

  const isAuthScreen = ["login", "onboarding"].includes(screen);
  const isBakingSession = screen === "new-session" || screen === "bake-again";
  const showSidebar = user && !isAuthScreen;

  // Auto-collapse sidebar during baking sessions
  useEffect(() => {
    if (isBakingSession && !sidebarCollapsed) set({ sidebarCollapsed: true });
    if (!isBakingSession && sidebarCollapsed && screen !== "new-session" && screen !== "bake-again") {
      // only auto-expand if user didn't manually collapse
    }
  }, [screen]);

  const sidebarWidth = showSidebar ? (sidebarCollapsed ? 64 : 220) : 0;

  const bakeAgainSession = state.bakeAgainSession;
  ...
  return (
    <div>
      ...
      <Notification data={state.notification} />
      ...
      {screen === "login" && <LoginScreen set={set} notify={notify} />}
      {screen === "onboarding" && <OnboardingScreen set={set} state={state} notify={notify} />}
      {screen === "dashboard" && <DashboardScreen state={state} set={set} sw={sidebarWidth} />}
      {screen === "new-session" && <BakingSessionScreen state={state} set={set} notify={notify} sw={sidebarWidth} />}
      {screen === "bake-again" && bakeAgainSession && <BakingSessionScreen state={state} set={set} notify={notify} sw={sidebarWidth} prefillSession={bakeAgainSession} />}
      {screen === "my-recipes" && <MyRecipesScreen state={state} set={set} notify={notify} sw={sidebarWidth} />}
      {screen === "resources" && <ResourcesScreen sw={sidebarWidth} />}
      {screen === "community" && <CommunityScreen notify={notify} sw={sidebarWidth} />}
      {screen === "settings" && <SettingsScreen state={state} set={set} notify={notify} sw={sidebarWidth} />}
    </div>
  );
}
